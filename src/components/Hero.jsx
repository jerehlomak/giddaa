  ...
  return (
    <div className='h-full w-full flex pb-20 md:pb-0 flex-col-reverse lg:flex-row justify-center'>
      <div className="container mt-10 w-full md:w-1/2">
        <div className="space-y-4 flex flex-col justify-center items-start text-start ">
          ...
          <div className='flex gap-8'>
            <button className='flex bg-[#335F32] tracking-widest rounded-full text-white py-2 px-4'>
              Find a Home
            </button>
